...
public class DbCreation
{
	...
	public static void main(String[] args)
	{
		...
		{	
			...
			statement.executeUpdate("CREATE TABLE IF NOT EXISTS JWEB.products (id INTEGER PRIMARY KEY AUTO_INCREMENT, category NVARCHAR(32), name NVARCHAR(32), image NVARCHAR(64), price FLOAT, description NVARCHAR(2048))");
			...
			statement.executeUpdate("INSERT INTO JWEB.products (category, name, image, price, description) VALUES ('blasters', 'Blaster','../JWeb/ressources/images/blaster_shop.jpg', 176, '	A blaster is any type of ranged weapon that fired bolts of intense light energy. They come in a variety of sizes and shapes. They deliver variable levels of damage intensity, from stun to kill settings. They also hit with great frictional or even explosive force, allowing a bolt to kill on impact even if the target is armored. Some blaster hits cause bleeding instead of burning, or do both, with the explosive force causing other damage around the wound. You do not like this guy ? Just kill him with this awesome blaster !')");
