...
<html>
	...
	<body>
		...
		<label>NomPUPUPUsh: <input type="text" name="pseudo"/></label><br/>
		...
		<label>Adresse postale: <input type="text" name="email"/></label><br/>
		<label>Date de naissance: <input type="text" name="email"/></label><br/>
