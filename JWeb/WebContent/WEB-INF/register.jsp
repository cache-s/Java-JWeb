	...
	<body>
		...
		<div class="main">
            ...
            <fieldset>
                ...
                <input type="text" id="lastName" name="lastName" value="<c:out value="${user.lastName}"/>" size="20" maxlength="20" />
                ...
                <input type="text" id="userName" name="userName" value="<c:out value="${user.userName}"/>" size="20" maxlength="20" />
                ...
                <input type="text" id="address" name="address" value="<c:out value="${user.address}"/>" size="20" maxlength="20" />
                <span class="error">${form.errors['address']}</span>
                <br />

                <label for="state">State</label>
                <input type="text" id="state" name="state" value="<c:out value="${user.state}"/>" size="20" maxlength="20" />
                <span class="error">${form.errors['state']}</span>
                <br />
                
				<label for="city">City</label>
                <input type="text" id="City" name="City" value="<c:out value="${user.city}"/>" size="20" maxlength="20" />
